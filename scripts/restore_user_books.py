...
사용법:
    ...
    docker compose exec -w /project backend python scripts/restore_user_books.py --input backups/user_books_20250222_120000.json
    docker compose exec -w /project backend python scripts/restore_user_books.py --input backup.json --clear
